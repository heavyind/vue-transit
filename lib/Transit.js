  ...
  return {
    ...
    computed: {
      ...
      shouldPlay () {
        ...
        if (this.intersect && (!this.isVisible)) {
          console.log("Intersection is required but the element is not within viewport");
          return false; 
        }
        console.log("Now it should play.");
        return true;
      },
      className () {
        if (!this.shouldPlay) { return ""; }
        console.log("The value of `if` is", this.if);
